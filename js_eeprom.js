...
const EEPROM_FACTORY_OFFSET = 0x30;
const EEPROM_FACTORY_SIZE = (0x5F - 0x30) + 1;
const EEPROM_FACTORY_CHECKSUM_OFFSET = 0x30;
const EEPROM_FACTORY_CHECKSUM_SIZE = 4;
const EEPROM_FACTORY_SERIAL_NUMBER_OFFSET = 0x34;
const EEPROM_FACTORY_SERIAL_NUMBER_SIZE = 12;
const EEPROM_FACTORY_MAC_ADDRESS_OFFSET = 0x40;
const EEPROM_FACTORY_MAC_ADDRESS_SIZE = 6;
const EEPROM_FACTORY_PADDING1_OFFSET = 0x46;
const EEPROM_FACTORY_PADDING1_SIZE = 2;
const EEPROM_FACTORY_ONLINE_KEY_OFFSET = 0x48;
const EEPROM_FACTORY_ONLINE_KEY_SIZE = 16;
const EEPROM_FACTORY_VIDEO_STANDARD_OFFSET = 0x58;
const EEPROM_FACTORY_VIDEO_STANDARD_SIZE = 4;
const EEPROM_FACTORY_PADDING2_OFFSET = 0x5C;
const EEPROM_FACTORY_PADDING2_SIZE = 4;
const EEPROM_USER_OFFSET = 0x60;
const EEPROM_USER_SIZE = (0xBF - 0x60) + 1;
const EEPROM_USER_CHECKSUM_OFFSET = 0x60;
const EEPROM_USER_CHECKSUM_SIZE = 4;
const EEPROM_USER_TIMEZONE_BIAS_OFFSET = 0x64;
const EEPROM_USER_TIMEZONE_BIAS_SIZE = 4;
const EEPROM_USER_TIMEZONE_STD_NAME_OFFSET = 0x68;
const EEPROM_USER_TIMEZONE_STD_NAME_SIZE = 4;
const EEPROM_USER_TIMEZONE_DLT_NAME_OFFSET = 0x6C;
const EEPROM_USER_TIMEZONE_DLT_NAME_SIZE = 4;
const EEPROM_USER_PADDING1_OFFSET = 0x70;
const EEPROM_USER_PADDING1_SIZE = 8;
const EEPROM_USER_TIMEZONE_STD_START_OFFSET = 0x78;
const EEPROM_USER_TIMEZONE_STD_START_SIZE = 4;
const EEPROM_USER_TIMEZONE_DLT_START_OFFSET = 0x7C;
const EEPROM_USER_TIMEZONE_DLT_START_SIZE = 4;
const EEPROM_USER_PADDING2_OFFSET = 0x80;
const EEPROM_USER_PADDING2_SIZE = 8;
const EEPROM_USER_TIMEZONE_STD_BIAS_OFFSET = 0x88;
const EEPROM_USER_TIMEZONE_STD_BIAS_SIZE = 4;
const EEPROM_USER_TIMEZONE_DLT_BIAS_OFFSET = 0x8C;
const EEPROM_USER_TIMEZONE_DLT_BIAS_SIZE = 4;
const EEPROM_USER_TIMEZONE_DATA_SIZE = (EEPROM_USER_TIMEZONE_BIAS_SIZE + EEPROM_USER_TIMEZONE_STD_NAME_SIZE +
    EEPROM_USER_TIMEZONE_DLT_NAME_SIZE + EEPROM_USER_PADDING1_SIZE + EEPROM_USER_TIMEZONE_STD_START_SIZE +
    EEPROM_USER_TIMEZONE_DLT_START_SIZE + EEPROM_USER_PADDING2_SIZE + EEPROM_USER_TIMEZONE_STD_BIAS_SIZE +
    EEPROM_USER_TIMEZONE_DLT_BIAS_SIZE);
const EEPROM_USER_LANGUAGE_OFFSET = 0x90;
const EEPROM_USER_LANGUAGE_SIZE = 4;
const EEPROM_USER_VIDEO_SETTINGS_OFFSET = 0x94;
const EEPROM_USER_VIDEO_SETTINGS_SIZE = 4;
const EEPROM_USER_AUDIO_SETTINGS_OFFSET = 0x98;
const EEPROM_USER_AUDIO_SETTINGS_SIZE = 4;
const EEPROM_USER_PARENTAL_CONTROL_GAMES_OFFSET = 0x9C;
const EEPROM_USER_PARENTAL_CONTROL_GAMES_SIZE = 4;
const EEPROM_USER_PARENTAL_CONTROL_PASSCODE_OFFSET = 0xA0;
const EEPROM_USER_PARENTAL_CONTROL_PASSCODE_SIZE = 4;
const EEPROM_USER_PARENTAL_CONTROL_MOVIES_OFFSET = 0xA4;
const EEPROM_USER_PARENTAL_CONTROL_MOVIES_SIZE = 4;
const EEPROM_USER_XLIVE_IP_ADDRESS_OFFSET = 0xA8;
const EEPROM_USER_XLIVE_IP_ADDRESS_SIZE = 4;
const EEPROM_USER_XLIVE_DNS_ADDRESS_OFFSET = 0xAC;
const EEPROM_USER_XLIVE_DNS_ADDRESS_SIZE = 4;
const EEPROM_USER_XLIVE_DEFAULT_GATEWAY_ADDRESS_OFFSET = 0xB0;
const EEPROM_USER_XLIVE_DEFAULT_GATEWAY_ADDRESS_SIZE = 4;
const EEPROM_USER_XLIVE_SUBNET_MASK_OFFSET = 0xB4;
const EEPROM_USER_XLIVE_SUBNET_MASK_SIZE = 4;
const EEPROM_USER_MISC_FLAGS_OFFSET = 0xB8;
const EEPROM_USER_MISC_FLAGS_SIZE = 4;
const EEPROM_USER_DVD_REGION_OFFSET = 0xBC;
const EEPROM_USER_DVD_REGION_SIZE = 4;
...
function eepromTest(versionChar, eepromUint8Array) {
    ...
    const hexBlob_debug = `
        ...
        00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 
        00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 
        00 00 00 00 00 00 82 51 80 00 00 00 00 00 00 00
    `;
